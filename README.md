...
Este é um projeto desenvolvido pelo discente Caio Cotrim Pereira, do curso de Sistemas de Informação do Instituto Federal da Bahia (IFBA) - Campus Vitória da Conquista, orientado pelo docente Dr. Leonardo Barreto Campos, em parceira com o Programa Institucional de Bolsas de Iniciação Científica [PIBIC] orfetado pelo CNPq.
...
- [**base-de-dados**](./base-de-dados/): Pasta que armazena o conteúdo da base de dados do projeto.

    - [**txt-files**](./base-de-dados/txt-files/): No momento, estamos utilizando arquivos de texto como fonte de dados. Esses arquivos de textos estão armazenados nesse diretório e dentro da pasta correspondente ao seu curso. 

        - [**ambiental**](./base-de-dados/txt-files/ambiental/): Aqui estão armazenados os arquivos de texto referentes ao curso de Bacharelado em Engenharia Ambiental.

        - [**bsi**](./base-de-dados/txt-files/bsi/): Aqui estão armazenados os arquivos de texto referentes ao curso de Bacharelado em Sistemas de Informação.

        - [**civil**](./base-de-dados/txt-files/civil/): Aqui estão armazenados os arquivos de texto referentes ao curso de Bacharelado em Engenharia Civil.

        - [**eletrica**](./base-de-dados/txt-files/eletrica/): Aqui estão armazenados os arquivos de texto referentes ao curso de Bacharelado em Engenharia Elétrica.

        - [**quimica**](./base-de-dados/txt-files/quimica/): Aqui estão armazenados os arquivos de texto referentes ao curso de Licenciatura em Química.


### 2.2 Arquivos
Os principais arquivos presentes no projeto são:
...
### 3.1 app.py
Este arquivo ([app.py](./app.py)) concentra o código-fonte do projeto e toda a lógica por trás do funcionamento do Assistente Virtual. 
...
while True:
    msg_usuario = input("Usuário: ")
    resposta = chain.invoke(msg_usuario)
